...
VALUES (
        ...
        'deepseek-coder:1.3b',
        -- A good model for strategic thinking and architecture
        0,
        -- Discussion
        0,
        -- Director
        ...
        -- Ollama endpoint
        0.7,
        -- Temperature (moderately creative)
        2048,
        -- NumPredict (longer responses for detailed planning)
        40,
        -- TopK
        0.9,
        -- TopP
        ...
        -- Seed (random)
        4096,
        -- NumCtx (large context for understanding full scope)
        1,
        -- NumGpu
        4,
        -- NumThread
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.3,
        -- Temperature (low for consistent, decisive answers)
        512,
        -- NumPredict (concise decisions)
        20,
        -- TopK
        0.8,
        -- TopP
...
VALUES (
        ...
        'deepseek-coder:1.3b',
        -- Lighter model for task coordination
        0,
        -- Discussion
        1,
        -- Manager
        ...
        'http://ollama:11434/api/generate',
        0.5,
        -- Temperature (moderate for balanced responses)
        1024,
        -- NumPredict
        30,
        -- TopK
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.3,
        -- Temperature (low for consistent decisions)
        512,
        -- NumPredict
        20,
        -- TopK
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.4,
        -- Temperature (low-moderate for objective analysis)
        1536,
        -- NumPredict (detailed feedback)
        30,
        -- TopK
        0.85,
        -- TopP
        ...
        -- Seed
        4096,
        -- NumCtx (needs full context for code review)
        1,
        -- NumGpu
        4,
        -- NumThread
        1.2,
        -- RepeatPenalty (slightly higher to avoid repetitive feedback)
        NULL,
        NOW(),
        NOW(),
        @coding_template_oid,
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.2,
        -- Temperature (very low for objective decisions)
        512,
        -- NumPredict
        20,
        -- TopK
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.4,
        -- Temperature (low-moderate for reliable code)
        2048,
        -- NumPredict (can generate longer code blocks)
        40,
        -- TopK
        0.9,
        -- TopP
        ...
        -- NumThread
        1.15,
        -- RepeatPenalty (higher to avoid repetitive code patterns)
        NULL,
        NOW(),
        NOW(),
        @coding_template_oid,
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.4,
        -- Temperature (moderate for balanced technical decisions)
        512,
        -- NumPredict
        30,
        -- TopK
...
VALUES (
        ...
        'gemma3:1b',
        -- Good for creative and strategic thinking
        0,
        -- Discussion
        0,
        -- Director
        ...
        'http://ollama:11434/api/generate',
        0.8,
        -- Temperature (higher for creative strategic thinking)
        2048,
        -- NumPredict
        50,
        -- TopK (higher for more creative options)
        0.95,
        -- TopP
        0,
        -- Seed
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.4,
        -- Temperature (moderate for balanced decisions)
        512,
        -- NumPredict
        30,
        -- TopK
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.6,
        -- Temperature (moderate for organizational thinking)
        1024,
        -- NumPredict
        40,
        -- TopK
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.4,
        -- Temperature (low-moderate for consistent decisions)
        512,
        -- NumPredict
        30,
        -- TopK
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.5,
        -- Temperature (moderate for balanced critique)
        1536,
        -- NumPredict (detailed feedback)
        40,
        -- TopK
        ...
        -- Seed
        4096,
        -- NumCtx (needs full context)
        1,
        -- NumGpu
        4,
        -- NumThread
        1.2,
        -- RepeatPenalty (avoid repetitive feedback)
        NULL,
        NOW(),
        NOW(),
        @writing_template_oid,
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.3,
        -- Temperature (low for objective decisions)
        512,
        -- NumPredict
        20,
        -- TopK
...
VALUES (
        ...
        'http://ollama:11434/api/generate',
        0.7,
        -- Temperature (moderate-high for creative writing)
        2048,
        -- NumPredict (longer content generation)
        50,
        -- TopK (more creative options)
        0.95,
        -- TopP
        0,
        -- Seed
        ...
        -- NumThread
        1.15,
        -- RepeatPenalty (avoid repetitive writing)
        NULL,
        NOW(),
        NOW(),
        @writing_template_oid,
