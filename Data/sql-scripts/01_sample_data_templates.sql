...
INSERT INTO Template ( Name, Description, Category, Version, Icon, IsActive, CreatedAt, UpdatedAt, OptimisticLockField, GCRecord)
VALUES (  -- OID (primary key)
    ...
    'coding',  -- Category
    '1.0.0',  -- Version
    'bi bi-code-slash text-primary',  -- Icon (Bootstrap Icons class)
...
VALUES (  -- OID (primary key)
    ...
    '1.0.0',  -- Version
    'bi bi-pen text-success',  -- Icon (Bootstrap Icons class)
    1,  -- IsActive (boolean, 1 = true)
    NOW(),  -- CreatedAt
    NOW(),  -- UpdatedAt
