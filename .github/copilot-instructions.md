...
-  Do not use camelCase for data in Data project, keep it as it is, data from backend uses PascalCase. Use camelCase only when some API required such as ollama, tensorRT... or any system required camelCase.
...
## 🔑 Controllers and WebAPI Integration
